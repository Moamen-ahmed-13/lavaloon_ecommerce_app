...
//                 );
//               }
//               // Handle main loaded state (with or without similar products)
...
//                                     onPressed: () => context
//                                         .read<ProductDetailsCubit>()
//                                         .requestAddToCart(state.product, 1),
...
//                               ],
//                             ),
//                             // Similar Products: Always access from state.similarProducts (no separate if)
...
//                                         index]; // Correct access: similarProducts (plural)
//                                     return SizedBox(
//                                       width: 120,
//                                       child: Card(
//                                         child: InkWell(
...
//                 );
//               }
//               // Fallback for other states (e.g., message)
//               return const Center(child: CircularProgressIndicator());
//             },
//           ),
//         ),
